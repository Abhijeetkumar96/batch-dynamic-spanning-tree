...
// Constructor
dynamic_tree_manager::dynamic_tree_manager(const std::vector<int>& parent, const std::string& delete_filename, const std::vector<uint64_t>& edge_list) {
    ...
    read_delete_batch(delete_filename);
