...
directory_path = '/Users/abhijitkumarsahu/spanning_tree/new_log_files/insertion/SG_PR_PR/csv/'
...
for file_path in file_paths:
    try:
        ...
        grouped_df = df.groupby('batch_size').agg({
            ...
            'num_comps': 'mean',  # Average of 'simple_BFS'
        ...
        grouped_df = grouped_df[['filename', 'numVertices', 'numEdges', 'batch_size', 'num_comps', 'total_time']]
        
        # Construct the output path using the constant filename and appending '_average.csv'
        output_path = f'/Users/abhijitkumarsahu/spanning_tree/new_log_files/insertion/SG_PR_PR/average/{base_filename}_average.csv'
