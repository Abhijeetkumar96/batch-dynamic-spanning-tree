...
void path_reversal_PR(dynamic_tree_manager& tree_ds, REP_EDGES& rep_edge_mag, thrust::device_vector<int> &onPath, thrust::device_vector<int> &pr_arr, thrust::device_vector<int> &pr_arr_size, int log_2_size, const int& unique_rep_count);
